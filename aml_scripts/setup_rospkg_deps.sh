...
if [ "$ROS_DISTRO" == "indigo" ]; then
  ...
  BLACK_LISTED_PKGS_ARG='-DCATKIN_BLACKLIST_PACKAGES=aml_sawyer_simulator;aml_sawyer_sim_controllers;aml_sawyer_gazebo;aml_sawyer_sim_hardware;aml_sawyer_sim_kinematics'
