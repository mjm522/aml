...
aruco::CameraParameters aruco_utils::rosCameraInfo2ArucoCamParams(const sensor_msgs::CameraInfo& cam_info,
...
tf::Transform aruco_utils::arucoMarker2Tf(const aruco::Marker &marker)
{
    ...
    // rotate_to_ros.at<float>(0,0) = -1.0; rotate_to_ros.at<float>(0,1) = 0.0; rotate_to_ros.at<float>(0,2) = 0.0;
    // rotate_to_ros.at<float>(1,0) = 0.0; rotate_to_ros.at<float>(1,1) = 1.0; rotate_to_ros.at<float>(1,2) = 0.0;
    // rotate_to_ros.at<float>(2,0) = 0.0; rotate_to_ros.at<float>(2,1) = 0.0; rotate_to_ros.at<float>(2,2) = 1.0;
    ...
    // tf::Matrix3x3 tf_rot(-rot.at<float>(0,0), rot.at<float>(0,2), rot.at<float>(0,1),
    //                      -rot.at<float>(1,0), rot.at<float>(1,2), rot.at<float>(1,1),
    //                      -rot.at<float>(2,0), rot.at<float>(2,2), rot.at<float>(2,1));
