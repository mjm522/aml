...
int main (int argc, char** argv)
{
  ...
  // std::string file = "/home/saif/Projects/aml_ws/src/aml/aml_data/image_0001.pcd";
  ...
  // sensor_msgs::PointCloud2::Ptr msg = processor.pcl_ros_converter_->ROSMsgFromPclCloudRGB(*cloud);
