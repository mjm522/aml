...
from aml_robot.box2d.push_world.config import config, pre_process_config

'''
This file takes in the data file generated by the push world (a .pkl file)
and then converts into a batch form that is usable by the aml_dl section
'''
