...
from aml_robot.mujoco.robot.mujoco_robot import MujocoRobot
from aml_robot.mujoco.simulator.mujoco_simulator   import  MujocoSimulator

def update_control(self, robot, cmd=None):
...
def main():
    ...
    simulate   = MujocoSimulator(mujoco_robot=robot)
