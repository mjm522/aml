...
fc_op = graph.get_operation_by_name('fc_out')
features_op = graph.get_operation_by_name('features_out')
loss_op = graph.get_operation_by_name('loss_out')
input_tensor = graph.get_tensor_by_name('nn_input:0')
